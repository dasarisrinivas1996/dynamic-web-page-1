...
var productList = [
  ...
  var accessorySection = document.getElementById("Accessories");
  var sectionWrapper1 = document.createElement("div");
  sectionWrapper1.id = "section-wrapper1";
  clothingSection.appendChild(sectionWrapper1);
  var sectionWrapper2 = document.createElement("div");
  sectionWrapper2.id = "section-wrapper2";
  accessorySection.appendChild(sectionWrapper2);


for(var i=0;i<productList.length;i++){
    // var cardWrapper1 = document.createElement("div");
    // sectionWrapper1.appendChild(cardWrapper1);
    // var cardWrapper2 = document.createElement?("div");
    // sectionWrapper2.appendChild(cardWrapper2);
    ...
    images.src = productList[i].preview;
    card.appendChild(images);
    var title = document.createElement("h2");
    title.innerHTML=productList[i].name;
    card.appendChild(title);
    var company = document.createElement("h3");
    company.innerHTML=productList[i].brand;
    card.appendChild(company);
    var cost = document.createElement("h4");
    cost.innerHTML="Rs "+productList[i].price;
    card.appendChild(cost);
    if (productList[i].isAccessory===false) {
        sectionWrapper1.appendChild(card);
    }else{
        sectionWrapper2.appendChild(card);
    }
}
